...
=======
          ...
          <div className="container">
  <div className="py-5 text-center">
    <img className="d-block mx-auto mb-8" 
    src="/docs/4.5/assets/brand/bootstrap-solid.svg" alt="" width="75" height="75"/>
    <h2>Checkout form</h2>
 ...
 <div className="col-md-5 order-md-5"> 
   <h4 className="mb-">Billing address</h4>
   <form className="needs-validation" novalidate="">
     <div className="row">
